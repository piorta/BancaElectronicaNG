...
@Component({
  selector: 'app-transf-activacion',
  templateUrl: './transf-activacion.component.html',
  styleUrls: ['./transf-activacion.component.css']
})
export class TransfActivacionComponent implements OnInit {
